...
#DOCS = README.pldotnet
#HEADERS_pldotnet = pldotnet.h
...
# Linux support
ifeq ($(UNAME), Linux)
	DOTNET_HOSTDIR ?= /usr/lib64/dotnet/packs/Microsoft.NETCore.App.Host.linux-x64/6.0.25/runtimes/linux-x64/native
	DOTNET_LIBDIR  ?= /usr/lib64/dotnet/packs/Microsoft.NETCore.App.Host.linux-x64/6.0.25/runtimes/linux-x64/native
